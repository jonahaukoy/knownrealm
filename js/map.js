  ...
  setTraveler(fraction) {
    ...
    try {
      ...
      if (dbg) {
        ...
        // reveal endpoint is at length = this._routeLen - current dashoffset
        ...
        console.log('map: clampedL=', clampedL, 'dashOff=', dashOff, 'revealLen=', revealLen);
      } else {
